...
import (
	...
	"github.com/opengovern/og-describer-linode/pkg/describer"
	model "github.com/opengovern/og-describer-linode/pkg/sdk/models"
	"github.com/opengovern/og-describer-linode/provider"
	"github.com/opengovern/og-describer-linode/provider/configs"
	"github.com/opengovern/og-describer-linode/steampipe"
...
var describerCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		creds := configs.IntegrationCredentials{
			Token: "01d87701288364d15065a2122813e668b81c8d3a00c415db32cf694b5d5a10ce",
		}
